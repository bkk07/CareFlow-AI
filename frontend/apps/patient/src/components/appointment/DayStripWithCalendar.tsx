...
import { parseDayKey, toLocalKey } from "../../lib/helpers";
...
/**
 * Horizontal 7-day strip (same look as before) + a calendar-icon button that
 * opens a month grid. Any day in any month can be picked; the parent moves
 * the strip to start from that day and fetches that day's schedule.
 */
